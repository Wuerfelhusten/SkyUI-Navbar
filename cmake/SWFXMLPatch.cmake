# Derived from SkyUI-Community's FFDec build pipeline; see THIRD_PARTY_NOTICES.md.
#[=======================================================================[.rst:
SWFXMLPatch
-----------
...
function(Add_XML_Base)
    ...
    set(_XML_SOURCE "${CMAKE_CURRENT_SOURCE_DIR}/src/ui/swf/${ARG_XML_PATH}")
    ...
    cmake_path(GET _XML_PATCHED PARENT_PATH _XML_PATCHED_DIR)
    ...
    if(ENABLE_FPS_PATCH AND _EXCLUDED_INDEX EQUAL -1)
        ...
        add_custom_command(
            OUTPUT "${_XML_PATCHED}"
            COMMAND "${CMAKE_COMMAND}" -E make_directory "${_XML_PATCHED_DIR}"
